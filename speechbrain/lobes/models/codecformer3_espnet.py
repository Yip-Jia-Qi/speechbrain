...
class DACWrapper():
    ...
    '''
    def __init__(self, input_sample_rate=8000, DAC_model_path = None, DAC_sample_rate = 16000, Freeze=True, pth_file_name=None):
        '''
        ...
        if DAC_model_path == None:
            ...
            self.model = DACGenerator(**generator_params)
            if pth_file_name == None:
                pth_file_name = '120epoch.pth'
            model_path = f'{DAC_model_path}/{pth_file_name}'
            print(model_path)
            load_pretrained_model(
    ...
    def get_quantized_features(self, x):
        ...
        x_qnt, codes_hat, _, commitment_loss_hat, codebook_loss_hat = self.model.quantizer(x, self.DAC_sample_rate)
        latents_hat = None
