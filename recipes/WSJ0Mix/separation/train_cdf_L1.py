...
class Separation(sb.Brain):
    def compute_forward(self, mix, targets, stage, noise=None):
        ...
        if self.hparams.quantize_before:
            self.hparams.dacmodel.get_quantized_features(mix_w)
    ...
    def fit_batch(self, batch):
        ...
        if self.auto_mix_prec:
            with autocast():
                ...
                loss = self.compute_objectives(predictions, targets_transmitted, mix_s, targ_w, mix_sq, targ_q, mix_sq_codes, targ_q_codes, sb.Stage.TRAIN)
            ...
            if (
                ...
                loss.data = torch.tensor(0,dtype=torch.float32).to(self.device)
    ...
    def evaluate_batch(self, batch, stage):
        ...
        with torch.no_grad():
            ...
            loss = self.compute_objectives(predictions, targets_transmitted, mix_s, targ_w, mix_sq, targ_q, mix_sq_codes, targ_q_codes, stage)
